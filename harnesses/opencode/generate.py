#!/usr/bin/env python3
"""Generate OpenCode harness configuration from the harness-agnostic policy."""
...
# already-resolved, so a symlink swapped in at "build/opencode" would
...
def generate_into(output: Path) -> None:
    ...
    if not profile_names:
        ...
        raise SystemExit(
            ...
            "refusing to generate an empty profile set"
        )
